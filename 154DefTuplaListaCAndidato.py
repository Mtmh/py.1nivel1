...
# -*- coding: utf-8 -*-
"""
Created on Fri Sep 15 18:17:29 2017
...
'''
Se tiene que cargar los votos obtenidos por 
tres candidatos a una elección.
En una lista cargar en la primer componente el nombre del candidato
 ...
 tupla con el nombre de la provincia y la cantidad
 de votos obtenidos en dicha provincia.
Se deben cargar los datos por teclado, pero si se cargaran
 por asignación tendría una estructura similar a esta:
candidatos=[("juan", [("cordoba",100),("buenos aires",200]]),
 ("ana", [("cordoba",55)]]), ("luis", [("buenos aires",20]])]
1) Función para cargar todos los candidatos, sus nombres y las provincias
