...
# -*- coding: utf-8 -*-
"""
Created on Tue Sep 19 22:02:50 2017
...
Declarar una clase Cuenta y dos subclases CajaAhorra y PlazoFijo.
 ...
 Definir los atributos y métodos comunes entre
 una caja de ahorro y un plazo fijo y agruparlos
 en la clase Cuenta.
 
Una caja de ahorro y un plazo fijo tienen un nombre de titular
 y un monto.

 Un plazo fijo añade un plazo de imposición en días y una tasa
 de interés.
