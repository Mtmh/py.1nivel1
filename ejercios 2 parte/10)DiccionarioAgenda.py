...
# -*- coding: utf-8 -*-
"""
Created on Fri Sep 22 00:01:10 2017

@author: tizianomartinhernando
"""

'''
10) Crea un diccionario donde la clave sea el nombre del usuario y el valor sea el teléfono (no es necesario validar). Tendrás que ir pidiendo contactos hasta
 el usuario diga que no quiere insertar mas.
